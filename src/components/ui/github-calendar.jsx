...
const colorSchemas = {
  ...
  green: {
    level0: "bg-zinc-100 dark:bg-zinc-900",
    level1: "bg-primary/40 dark:bg-primary/40",
    level2: "bg-primary/60 dark:bg-primary/60",
    level3: "bg-primary/80 dark:bg-primary/80",
    level4: "bg-primary dark:bg-primary",
  },
  blue: {
    level0: "bg-zinc-100 dark:bg-zinc-900",
...
export function GithubCalendar({
  ...
  return (
    <div className={cn("w-full max-w-full flex flex-col gap-4", className)}>
      {showTotal && (
      ...
      <div
        className="relative flex flex-nowrap gap-[3px] w-full max-w-full"
        onMouseLeave={() => {
          setHoveredDate(null);
      ...
      >
        ...
        {weeks.map((week, weekIndex) => (
          <div key={weekIndex} className="flex flex-col gap-[3px] w-[19px]">
