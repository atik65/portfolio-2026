  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(".back-btn", { opacity: 0, x: -20, duration: 0.8, ease: "power3.out" })
        ...
        .from(".action-buttons", { opacity: 0, y: 30, duration: 0.8, ease: "power3.out" }, "-=0.4");
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <button 
          onClick={onBack}
          className="back-btn flex items-center gap-3 text-white/40 hover:text-white transition-all mb-16 md:mb-24 group cursor-pointer"
        >
          ...
          <span className="text-xs font-black tracking-[0.2em] uppercase">Back to Projects</span>
        </button>
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-start">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32 space-y-12 action-buttons">
              ...
              <div className="px-4">
                <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] mb-4">Project Timeline</p>
                <p className="text-white font-headline font-bold text-lg italic">2024 — Modernizing Procurement</p>
              </div>
            </div>
          </div>
        </div>
                ...
                >
                   ...
                   <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 bg-black/40 backdrop-blur-[2px] transform translate-y-4 group-hover:translate-y-0">
                      <div className="bg-white/10 px-8 py-4 rounded-full border border-white/20 flex items-center gap-3 transform scale-90 group-hover:scale-100 transition-transform duration-500">
                        ...
                        <span className="text-sm font-black tracking-widest uppercase">View Fullscreen</span>
                      </div>
                   </div>
                </div>
              ))}
      ...
      {selectedImage && (
        ...
        >
          ...
          <div className="max-w-7xl max-h-[90vh] w-full px-6 flex items-center justify-center" onClick={(e) => e.stopPropagation()}>
            <img 
              src={selectedImage} 
