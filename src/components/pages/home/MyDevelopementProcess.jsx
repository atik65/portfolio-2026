  ...
  const steps = [
    {
      ...
      description:
        "Crafting clean, scalable code using modern frameworks and performance-first modular architecture.",
      icon: Code,
    },
    {
      title: "Deployment & Launch",
      description:
        "Seamless CI/CD integration and cloud deployment ensuring high availability and global reach.",
      icon: Rocket,
    },
    {
      title: "Maintenance & Support",
      description:
        "Continuous monitoring, regular security updates, and performance optimization post-launch.",
      icon: ShieldCheck,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative">
        ...
        <div ref={headerRef} className="text-center mb-20 space-y-4">
          ...
          <h2 className="text-4xl md:text-6xl font-headline font-black text-white tracking-tighter leading-tight">
            <TextRepel text="Development" />
            <span className="text-primary italic ps-3">
              <TextRepel text="Process" />
            </span>
          </h2>
          <p className="text-white/40 max-w-xl mx-auto text-sm md:text-base">
            A streamlined approach to turning complex ideas into
            high-performance digital solutions with technical precision.
          </p>
        </div>
        ...
        >
          <div className="md:col-span-2 bg-white/5 rounded-[32px] p-8 md:p-10 border border-white/5 backdrop-blur-sm group hover:border-primary/20 transition-colors duration-500">
            <div className="text-primary font-black text-xs tracking-widest uppercase mb-4">
              01. Strategy
            </div>
            ...
            <p className="text-white/40 text-sm md:text-base leading-relaxed">
              Every project begins with a comprehensive audit of your technical
              requirements and business goals to ensure the optimal tech stack
              selection and architectural roadmap.
            </p>
          </div>
          ...
          <div className="bg-white/5 rounded-[32px] p-8 md:p-10 border border-white/5 flex flex-col justify-center items-center text-center group hover:border-primary/20 transition-colors duration-500">
            ...
            <div className="text-[10px] uppercase tracking-widest font-black text-white/30 group-hover:text-white/60 transition-colors">
              Code Coverage
            </div>
