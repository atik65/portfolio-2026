  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={contentRef} className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
           
           {/* Left Section: Info */}
           <div className="space-y-12">
              <div className="contact-info-item">
                 <h3 className="text-5xl md:text-6xl font-headline font-black text-white leading-[1.1] mb-2">
                   Have a <span className="bg-gradient-to-r from-white via-primary/80 to-primary bg-clip-text text-transparent italic pr-2">cool</span>
                 </h3>
                 <h3 className="text-5xl md:text-6xl font-headline font-black text-white leading-[1.1]">
                   <span className="bg-gradient-to-r from-white via-primary/80 to-primary bg-clip-text text-transparent italic pr-2">project?</span> Get in touch!
                 </h3>
              </div>
              ...
              <div className="space-y-12 mt-16">
                ...
                <div className="contact-info-item group relative pl-20 transition-all duration-300">
                   <span className="absolute left-0 top-0 text-8xl font-black text-white/[0.08] select-none transition-all duration-500 group-hover:text-primary/10 leading-none -ml-4">01</span>
                   <p className="text-[10px] uppercase tracking-[0.2em] font-black text-white/30 mb-2 relative z-10">Email</p>
                   <a href="mailto:atik.hasan.dev@gmail.com" className="text-xl md:text-2xl font-headline font-bold text-white hover:text-primary transition-colors relative z-10">
                ...
                {/* Location */}
                <div className="contact-info-item group relative pl-20 transition-all duration-300">
                   <span className="absolute left-0 top-0 text-8xl font-black text-white/[0.08] select-none transition-all duration-500 group-hover:text-primary/10 leading-none -ml-4">02</span>
                   <p className="text-[10px] uppercase tracking-[0.2em] font-black text-white/30 mb-2 relative z-10">Location</p>
