  ...
  const topServices = [
    {
      ...
      description:
        "Crafting highly interactive, responsive, and accessible user interfaces using React and Next.js, with a focus on core web vitals and premium aesthetics.",
      icon: Code,
    },
    {
      title: "Backend Engineering",
      description:
        "Building robust, secure server-side architectures and APIs using Django and Express to power complex business logic and high-performance apps.",
      icon: Terminal,
    },
    {
      title: "UI/UX Implementation",
      description:
        "Bridging the gap between design and development by turning complex prototypes into pixel-perfect, fluidly animated web experiences.",
      icon: Palette,
    },
  ];
  ...
  const bottomServices = [
    {
      ...
      description:
        "Delivering cross-platform mobile solutions that provide native performance and seamless experiences across iOS and Android devices.",
      icon: Smartphone,
    },
    {
      title: "Cloud & Optimization",
      description:
        "Managing scalable cloud deployments and optimizing application performance, SEO, and security for a production-ready presence.",
      icon: Cloud,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={headerRef} className="text-center mb-20 space-y-4">
          ...
          <h2 className="text-4xl md:text-6xl font-headline font-black text-white tracking-tighter leading-tight">
            ...
            <span className="text-primary italic ps-2">
              <TextRepel text="Services" />
            </span>
          </h2>
          <p className="text-white/40 max-w-xl mx-auto text-sm md:text-base">
            Delivering end-to-end software solutions from conceptualization to
            deployment, ensuring performance, scalability, and exceptional user
            journeys.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div ref={grid2Ref} className="grid grid-cols-1 md:grid-cols-2 gap-6">
